//
//  SWNoImproveWKWebViewController.swift
//  LearnSwift
//
...
class SWNoImproveWKWebViewController: UIViewController {
    ...
    func configNav()  {
        self.title = "WkWebView没有缓存体验"
    }
    
    
    func initWebview()  {
        webview = ZJWebView.init(frame: .zero, configuration: ZJWebView.defaultConfiguation())
